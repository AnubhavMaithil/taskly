...
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| ![Login Screen](docs/screenshots/web/login-web.png) Login screen                                 | ![Signup Screen](docs/screenshots/web/signup-web.png) Signup screen                              |
| ![Dashboard Overview](docs/screenshots/web/dashboard-web.png) Dashboard overview                 | ![Create Task Modal](docs/screenshots/web/new-task-web.png) Create task modal                    |
| ![Task Filtering](docs/screenshots/web/task-filter-completed-web.png) Task filtering (Completed) | ![Pending Filter State](docs/screenshots/web/task-filter-pending-web.png) Pending filter state   |
| ![Completed Task State](docs/screenshots/web/task-complete-web.png) Completed task state         | ![Dynamic feedback](docs/screenshots/web/dashboard-toast-web.png) Dynamic feedback after actions |

### Mobile

| Screenshot                                                                                                | Screenshot                                                                                   |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| ![Login Mobile](docs/screenshots/mobile/login-mobile.png) Mobile login flow                          | ![Signup Mobile](docs/screenshots/mobile/signup-mobile.png) Mobile signup flow          |
| ![Dashboard Mobile](docs/screenshots/mobile/dashboard-mobile.png) Responsive dashboard               | ![New Task Mobile](docs/screenshots/mobile/new-task-mobile.png) Task creation on mobile |
| ![Productivity Screen](docs/screenshots/mobile/productivity-screen-mobile.png) Productivity overview | ![Logout Mobile](docs/screenshots/mobile/logout-mobile.png) Secure logout               |
